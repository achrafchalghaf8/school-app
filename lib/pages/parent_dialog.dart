...
class _ParentDialogState extends State<ParentDialog> {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      title: Text(widget.parent == null ? context.tr('parents.add_parent') : context.tr('parents.edit_parent')),
      content: Form(
        key: _formKey,
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(labelText: context.tr('parents.form_email')),
                validator: (value) {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: context.tr('parents.form_name')),
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: context.tr('parents.form_password')),
                obscureText: true,
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: context.tr('parents.form_phone')),
