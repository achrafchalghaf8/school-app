...
class _StudentDetailsPageState extends State<StudentDetailsPage> {
      ...
      appBar: AppBar(
        title: Text(
          _etudiantDetails != null 
            ...
            : context.tr('parents.student_details.page_title'),
                      ...
                      children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          context.tr('parents.student_details.student_label'),
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w500,
                                        ...
                                        Text(
                                          _etudiantDetails != null
                                              ? '${_etudiantDetails!['prenom']} ${_etudiantDetails!['nom']}'
                                              : context.tr('parents.student_details.not_specified'),
                                          style: TextStyle(
                                            fontSize: 20,
                                            fontWeight: FontWeight.w700,
                                        ...
                                        Text(
                                          context.tr('parents.student_details.class_level'),
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.blue.shade600,
                                        ...
                                        Text(
                                          _classeDetails != null
                                              ? _classeDetails!['niveau'] ?? context.tr('parents.student_details.not_specified')
                                              : context.tr('parents.student_details.not_specified'),
                                          style: TextStyle(
                                            fontSize: 18,
                        ...
                        GridView.count(
                          ...
                          children: [
                            _buildActionCard(
                              icon: Icons.schedule,
                              title: context.tr('parents.student_details.schedule'),
                              onTap: _navigateToSchedule,
                            ),
                            _buildActionCard(
                              icon: Icons.menu_book,
                              title: context.tr('parents.student_details.courses'),
                              onTap: _navigateToCourses,
                            ),
                            _buildActionCard(
                              icon: Icons.person,
                              title: context.tr('parents.student_details.pickup_child'),
                              onTap: _navigateToPickup,
                            ),
                            _buildActionCard(
                              icon: Icons.logout,
                              title: context.tr('parents.student_details.logout'),
                              onTap: _logout,
  ...
  void _navigateToPickup() {
    if (_etudiantDetails == null) return;
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => Scaffold(
          appBar: AppBar(
            title: Text(
              context.tr('parents.student_details.pickup_child'),
              style: TextStyle(
                fontWeight: FontWeight.w700,
                fontSize: 20,
                color: Colors.white,
            ...
            child: Padding(
              ...
              child: Card(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text(
                    context.tr('parents.student_details.pickup_request').replaceAll('{name}', '${_etudiantDetails!['prenom']} ${_etudiantDetails!['nom']}'),
                    style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.w600,
                      color: Colors.blue.shade900,
