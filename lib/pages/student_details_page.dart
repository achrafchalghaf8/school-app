...
class _StudentDetailsPageState extends State<StudentDetailsPage> {
  ...
  Future<void> _fetchStudentAndClassDetails() async {
    try {
      ...
      if (classeId == null) {
        throw Exception('Classe ID not found');
      }
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _classeDetails != null
                                              ? _classeDetails!['niveau'] ?? 'Non spécifié'
                                              : 'Non spécifié',
                                          style: TextStyle(
                                            fontSize: 18,
            ...
            child: Padding(
              ...
              child: Card(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text(
                    'Demande de récupération pour ${_etudiantDetails!['prenom']} ${_etudiantDetails!['nom']}',
                    style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.w600,
                      color: Colors.blue.shade900,
