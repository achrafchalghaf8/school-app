...
class _TeacherDialogState extends State<TeacherDialog> {
  ...
  void initState() {
    ...
    _passwordController = TextEditingController(text: widget.teacher == null ? (widget.teacher?['password'] ?? '') : '');
                ...
                children: [
                  ...
                  _buildFormField(
                    ...
                    label: widget.teacher == null 
                        ? context.tr('teachers.form_password')
                        : context.tr('teachers.form_new_password'),
                    icon: Icons.lock,
                    obscureText: true,
                    validator: (value) {
                      if (value == null || value.isEmpty) {
