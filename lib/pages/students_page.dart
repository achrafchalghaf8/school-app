  ...
  void _onSearchChanged() {
    ...
    setState(() {
      filteredStudents = allStudents.where((student) {
        ...
        final className = getClassName(student['classeId']).toLowerCase();
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      if (studentsResponse.statusCode == 200 && 
        ...
        setState(() {
          allStudents = json.decode(studentsResponse.body);
          filteredStudents = json.decode(studentsResponse.body);
  ...
  Future<void> deleteStudent(int id) async {
    try {
      ...
      if (response.statusCode == 204) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(context.tr('students.delete_success')),
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(_currentStudent == null 
                  ? context.tr('students.add_success') 
                  : context.tr('students.edit_success')),
              backgroundColor: Colors.green.shade600,
              behavior: SnackBarBehavior.floating,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(10),
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: context.tr('students.search_hint'),
                    ...
                    ? Center(
                        child: Text(
                          _searchController.text.isEmpty
                              ? context.tr('students.no_students')
                              : context.tr('students.no_results'),
