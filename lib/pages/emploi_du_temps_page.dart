...
class _EmploiDuTempsPageState extends State<EmploiDuTempsPage> {
  ...
  Future<void> _prepareFile([Map<String, dynamic>? emploi]) async {
    ...
    try {
      ...
      if (base64String.isEmpty) {
        throw Exception('Fichier base64 vide');
      }
      ...
      setState(() {
        _errorMessage = 'Impossible de préparer le fichier: ${e.toString()}';
      });
      if (mounted) {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'PDF - Cliquez pour ouvrir/télécharger',
                      style: TextStyle(
                        fontSize: 16,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'Fichier - Cliquez pour ouvrir/télécharger',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        color: Colors.blue.shade900,
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      'Taille: ${(_fileBytes!.length / 1024).toStringAsFixed(1)} KB',
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.blue.shade600,
                      ),
  ...
  Widget _buildFilePreview() {
    ...
    final dateStr = datePublication != null
        ...
        : _selectedEmploi!['datePublication'] ?? 'Date inconnue';
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      'Emploi du temps le plus récent',
                      style: TextStyle(
                        fontSize: 18,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Emploi du temps - ${widget.niveauClasse}',
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    '${_emplois.length} emploi(s) du temps disponible(s)',
                                    style: TextStyle(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w500,
                                      color: Colors.blue.shade600,
