...
class _CoursesPageState extends State<CoursesPage> {
  ...
  Future<void> _fetchCoursesAndExercices() async {
    try {
      ...
      if (coursResponse.statusCode != 200) {
        throw Exception(LocalizationService().translate('parents.courses.failed_load_courses'));
      }
      ...
      if (exercicesResponse.statusCode != 200) {
        throw Exception(LocalizationService().translate('parents.courses.failed_load_exercises'));
      }
      ...
      setState(() {
        _isLoading = false;
        _errorMessage = '${LocalizationService().translate('parents.courses.loading_error')}: ${e.toString()}';
      });
    }
  }
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (result.type != ResultType.done) {
          _showErrorSnackbar(LocalizationService().translate('parents.courses.no_app_open_file'));
        }
      }
    } catch (e) {
      _showErrorSnackbar('${LocalizationService().translate('parents.courses.cannot_open_file')}: ${e.toString()}');
    }
  }
    ...
    try {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            context.tr('parents.courses.file_number').replaceAll('{number}', (fileIndex + 1).toString()),
                            style: TextStyle(
                    ...
                    IconButton(
                      ...
                      tooltip: context.tr('parents.courses.download'),
                    ),
                  ],
                ),
      ...
      return Card(
        ...
        child: ListTile(
          ...
          title: Text(
            context.tr('parents.courses.corrupted_file'),
            style: TextStyle(color: Colors.blue.shade900),
          ),
          subtitle: Text(
            context.tr('parents.courses.contact_teacher'),
  ...
  Widget _buildFileList(String filesString, String fileNamePrefix) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          context.tr('parents.courses.files').replaceAll('{type}', fileNamePrefix),
          style: TextStyle(
            fontWeight: FontWeight.w600,
            fontSize: 16,
            color: Colors.blue.shade900,
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      appBar: AppBar(
        title: Text(
          context.tr('parents.courses.page_title').replaceAll('{class}', widget.niveauClasse),
        ...
        actions: [
          LanguageSelector(
            showAsDialog: false,
            onLanguageChanged: () {
              // Rafraîchir la page après changement de langue
              setState(() {});
            },
          ),
        ],
              ...
              : _coursList.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final matiere = cours['matiere'] ?? context.tr('parents.courses.unknown_subject');
                          ...
                          child: Card(
                            ...
                            child: ExpansionTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  Text(
                                    '${associatedExercices.length} ${associatedExercices.length != 1 ? context.tr('parents.courses.exercises') : context.tr('parents.courses.exercise')}',
                                    style: TextStyle(
                                      color: Colors.blue.shade600,
                                      fontSize: 14,
                                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      if (fichier.isNotEmpty && fichier != "no content")
                                        _buildFileList(fichier, context.tr('common.course')),
                                            ...
                                            child: Card(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      exercice['contenu'] ?? context.tr('parents.courses.exercise_no_description'),
                                                      style: TextStyle(
                                                        fontSize: 14,
                                                        fontWeight: FontWeight.w500,
                                                    ...
                                                    if (exerciceFile.isNotEmpty && exerciceFile != "no content")
                                                      Padding(
                                                        padding: const EdgeInsets.only(top: 12.0),
                                                        child: _buildFileList(exerciceFile, context.tr('common.exercise')),
                                                      ),
                                                    const SizedBox(height: 8),
                                                    Text(
                                                      context.tr('parents.courses.published_on').replaceAll('{date}', exercice['datePublication'] ?? context.tr('parents.courses.unknown_date')),
                                                      style: TextStyle(
                                                        fontSize: 12,
                                                        color: Colors.blue.shade600,
                                                      ),
