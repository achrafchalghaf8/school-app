...
class AdminDrawer extends StatelessWidget {
  ...
  List<Widget> _buildMenuItems(BuildContext context) {
    final menuItems = [
      ...
      {'icon': Icons.account_circle, 'title': context.tr('admin.accounts'), 'route': '/admin/accounts'},
      ...
      {'icon': Icons.settings, 'title': context.tr('navigation.settings'), 'route': '/admin/settings'},
    ];
