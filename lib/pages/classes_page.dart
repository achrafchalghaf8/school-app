...
class _ClassesPageState extends State<ClassesPage> {
  ...
  void _filterClasses(String searchTerm) {
    ...
    setState(() {
      _filteredClasses = _classes.where((classe) {
        final niveauMatch = classe['niveau']?.toString().toLowerCase().contains(term) ?? false;
        
        // Recherche dans les noms des enseignants
        final enseignantIds = List<int>.from(classe['enseignantIds'] ?? []);
        final enseignants = _enseignants.where((e) => enseignantIds.contains(e['id']));
        final enseignantsMatch = enseignants.any((e) => 
            e['nom']?.toString().toLowerCase().contains(term) ?? false);
        
        return niveauMatch || enseignantsMatch;
      }).toList();
    });
  }
          ...
          children: [
            ...
            if (_searchController.text.isNotEmpty)
              TextButton(
                ...
                child: Text(context.tr('classes.clear_search')),
              ),
          ],
        ),
      );
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: context.tr('classes.search_hint'),
