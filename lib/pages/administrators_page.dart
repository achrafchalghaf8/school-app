...
class _AdministratorsPageState extends State<AdministratorsPage> {
  ...
  List<User> _allAdmins = [];
  List<User> _filteredAdmins = [];

  @override
  void initState() {
    super.initState();
    _adminsFuture = _getAdmins().then((admins) {
      _allAdmins = admins;
  ...
  void _onSearchChanged() {
    ...
    setState(() {
      _filteredAdmins = _allAdmins.where((admin) {
        return admin.nom.toLowerCase().contains(query) || 
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: context.tr('administrators.search_hint'),
              ...
              child: FutureBuilder<List<User>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Center(child: Text(context.tr('administrators.no_admins_found'), style: const TextStyle(color: Colors.grey)));
                  }
