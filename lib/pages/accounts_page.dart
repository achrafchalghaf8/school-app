    ...
    return showDialog<String>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Text(
            isUpdate ? context.tr('accounts.change_password') : context.tr('accounts.set_password'),
          ...
          content: TextField(
            ...
            decoration: InputDecoration(
              labelText: isUpdate ? context.tr('accounts.new_password_optional') : context.tr('login.password'),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          backgroundColor: Colors.white,
          title: Text(
            user == null ? context.tr('accounts.add_account') : context.tr('accounts.edit_account'),
            style: TextStyle(color: Colors.blue.shade900, fontWeight: FontWeight.bold),
          ),
          ...
          actions: [
            ...
            ElevatedButton(
                ...
                try {
                  if (user == null) {
                    ...
                    if (password == null || password.isEmpty) {
                      throw Exception(context.tr('accounts.password_required'));
                    }
              ...
              child: Text(user == null ? context.tr('common.add') : context.tr('accounts.update'), style: const TextStyle(fontWeight: FontWeight.w600)),
            ),
          ],
        );
      },
            ...
            child: FutureBuilder<List<User>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Center(child: Text(context.tr('accounts.no_accounts'), style: const TextStyle(color: Colors.grey)));
                }
