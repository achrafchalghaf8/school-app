...
class _ExercicesPageState extends State<ExercicesPage> {
  ...
  final List<Exercice> _filteredExercices = [];
  ...
  void initState() {
    super.initState();
    _fetchData();
    _searchController.addListener(_filterExercices);
  }
  ...
  void _filterExercices() {
    ...
    if (query.isEmpty) {
      setState(() {
        _filteredExercices.clear();
        _filteredExercices.addAll(_exercices);
      });
    } else {
      setState(() {
        _filteredExercices.clear();
        _filteredExercices.addAll(_exercices.where((exercice) {
          final classeNames = exercice.classeIds
          ...
          final coursName = _cours
              .firstWhere(
                (c) => c.id == exercice.courId,
                orElse: () => Cours(id: 0, matiere: context.tr('common.unknown')),
              ).matiere.toLowerCase();

          return exercice.contenu.toLowerCase().contains(query) ||
              classeNames.contains(query) ||
              coursName.contains(query) ||
              exercice.datePublication.toLowerCase().contains(query);
        }).toList());
      });
    }
  }
                ...
                children: [
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: context.tr('exercises.search_hint'),
                  ...
                  Expanded(
                    child: _filteredExercices.isEmpty
                        ? Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  _searchController.text.isEmpty
                                      ...
                                      : context.tr('exercises.no_results'),
                                  style: TextStyle(
                                    fontSize: 18,
                                    color: Colors.grey.shade600,
                                  ),
                                ...
                                if (_searchController.text.isNotEmpty) ...[
                                  ...
                                  ElevatedButton(
                                    ...
                                    child: Text(context.tr('common.clear_search')),
                                  ),
                                ],
                              ],
                            ),
                        ...
                        : SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 16),
                                ..._filteredExercices.map((exercice) {
