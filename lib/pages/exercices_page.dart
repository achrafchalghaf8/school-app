...
class _ExercicesPageState extends State<ExercicesPage> {
  ...
  Future<void> _downloadAndOpenFile(String base64String, String fileName) async {
    try {
      ...
      final downloadFileName = fileName.isNotEmpty 
          ? fileName 
          : 'exercice_${DateTime.now().millisecondsSinceEpoch}.$extension';
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        exercice == null ? 'Ajouter un exercice' : 'Modifier l\'exercice',
                        style: TextStyle(
                          fontSize: 18,
                      ...
                      Text('Classes', style: TextStyle(fontWeight: FontWeight.w500)),
                      ...
                      Text('Cours', style: TextStyle(fontWeight: FontWeight.w500)),
                      const SizedBox(height: 8),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Voulez-vous vraiment supprimer cet exercice ?'),
              const SizedBox(height: 16),
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Gestion des Exercices', style: TextStyle(color: Colors.white)),
        centerTitle: true,
