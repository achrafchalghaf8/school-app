...
class Classe {
  ...
  factory Classe.fromJson(Map<String, dynamic> json) {
    return Classe(
      id: json['id'] ?? 0,
      niveau: json['niveau'] ?? '',
      enseignantIds: List<int>.from(json['enseignantIds'] ?? []),
    );
  }
}
...
class _WelcomeTeacherPageState extends State<WelcomeTeacherPage> {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      appBar: AppBar(
        title: Text(
          context.tr('teacher.teacher_space'),
        ...
        actions: [
          IconButton(
            ...
            onPressed: _logout,
            tooltip: context.tr('teacher.logout'),
          ),
        ],
      ),
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(context.tr('teacher.retry')),
                ),
              ],
            ),
          ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            context.tr('teacher.no_classes_assigned'),
            style: TextStyle(
